...
let ContactComponent = class ContactComponent {
    constructor(formBuilder, snackBar, fb, appService) {
    ...
    ngOnInit() {
        ...
        for (let index = 0; index < this.stateTransaction.numAdults; index++) {
            this.users.push((this.contactForm = this.fb.group({
                ...
                email: [
                    "",
                    _angular_forms__WEBPACK_IMPORTED_MODULE_4__.Validators.compose([_angular_forms__WEBPACK_IMPORTED_MODULE_4__.Validators.required, src_app_theme_utils_app_validators__WEBPACK_IMPORTED_MODULE_2__.emailValidator]),
                ],
